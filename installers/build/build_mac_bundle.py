...
print('  2. Открыть Терминал')
print('  3. Ввести: bash ')
print('  4. Перетащить install.command в окно Терминала и нажать Enter')
print('     Важно: кавычки и обратные слэши в подставленном пути не удалять')
print('  5. Следовать инструкциям установщика')
