...
const suites = [
  ...
  'native-late-repository-proof-regression.mjs',
...
const validationScope = requested.size ? (['time-focused','marker-focused','sort-focused','search-focused'].includes(process.env.PENA_TEST_PROFILE) ? process.env.PENA_TEST_PROFILE : 'selected') : 'full';
if (['time-focused','marker-focused','sort-focused','search-focused'].includes(validationScope)) {
